            ...
            <div class="form-group">
                ...
                <div class=" col-md-9">
                    ...
                    <!-- <select name="job_title" id="job_title">
                      ...
                      <option value="DIREKTUR OPERASI">DIREKTUR OPERASI</option>
                      <option value="MANAJER KEUANGAN">MANAJER KEUANGAN</option>
                      <option value="MANAJER SDM UMUM">MANAJER SDM UMUM</option>
                      <option value="AKUNTANSI & KEUANGAN">AKUNTANSI & KEUANGAN</option>
                      <option value="SDM">SDM</option>
                      <option value="UMUM & ADMINISTRASI">UMUM & ADMINISTRASI</option>
                      <option value="DIVISI STONE CRUSHER">DIVISI STONE CRUSHER</option>
                      <option value="DIVISI BETON">DIVISI BETON</option>
                      <option value="KORWIL 1">KORWIL 1</option>
                      <option value="KORWIL 2">KORWIL 2</option>
                      <option value="KORWIL 3">KORWIL 3</option>
                ...
                echo form_dropdown(
                    "job_title", array(
                        ...
                        "MANAJER SDM UMUM" => "MANAJER SDM UMUM",
                        "AKUNTANSI & KEUANGAN"=>"AKUNTANSI & KEUANGAN",
                        "SDM"=>"SDM",
                        "UMUM & ADMINISTRASI"=>"UMUM & ADMINISTRASI",
                        "DIVISI STONE CRUSHER"=>"DIVISI STONE CRUSHER",
                        "DIVISI BETON"=>"DIVISI BETON",
                        "KORWIL 1"=>"KORWIL 1",
                        "KORWIL 2"=>"KORWIL 2",
                        "KORWIL 3"=>"KORWIL 3",
                        "SPI"=>"SPI"
