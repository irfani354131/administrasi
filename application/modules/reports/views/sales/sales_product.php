               ...
               <table class="table table-bordered">
                   <tr>
						...
						<td>
                         ...
                         <td><select name="penjualan" id="penjualan" class="form-control">
                            <option value="online">Online</option>
                            <option value="offline">Offline</option>
                            </select></td>
                        <td>
                            <button type="submit" name="search" class="btn btn-default" value="1"><i class=" fa fa-search"></i> Filter</button>
                            <a href="#" name="print"  class="btn btn-default" onclick="tableToExcel('table-print', 'Lap_Penjualan')"><i class=" fa fa-file-excel-o"></i> Excel</a>
            	...
            	<div>
                    ...
                    <p><strong><?php echo $date_range ?></strong></p>
            			...
            			<tr>
            				...
            				<td style="text-align: center;"><?php  echo $row->penjualan; ?></td>
