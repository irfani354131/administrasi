...
class General_ledger extends MY_Controller {
    ...
    function getReport(){
        ...
        //if(!empty($id)){
            $where_coa = "AND a.fid_coa = '$coadb->no_coa'  ";
        ...
        $jml_cre = 0;
            ...
            $data = $this->db->query("SELECT a.*,b.account_number,b.account_name,b.normally,h.description FROM transaction_journal a JOIN acc_coa_type b ON b.id  = a.fid_coa JOIN transaction_journal_header h ON h.id = a.fid_header WHERE  a.deleted = 0 $where_coa $where ORDER BY a.date,a.voucher_code ASC");
