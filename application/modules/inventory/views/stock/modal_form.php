<?php echo form_open(get_uri("inventory/stock/add"), array("id" => "stock-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="tab-content mt15">
        <div role="tabpanel" class="tab-pane active" id="general-info-tab">
           ...
           <div class="form-group">
                ...
                <div class=" col-md-9">
                    <?php
                    echo form_dropdown("master_warehouse_id", $data_warehouse, "", "class='select2 validate-hidden' id='master_warehouse_id' ");
            ...
            <div class="form-group">
                ...
                <div class=" col-md-9">
                    <?php
                    echo form_dropdown("master_items_id", $data_items, "", "class='select2 validate-hidden' id='master_items_id' ");
