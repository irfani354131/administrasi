...
// print_r($dtSparePt);
// echo $dtSparePt->kuantitas_pembelian;
?>
<div id="page-content" class="clearfix">
    <div style="max-width: 1000px; margin: auto;">
        <div class="page-title clearfix mt15">
            <h1> Pengeluaran <?php echo get_order_id($data_info->code); ?>
        ...
        <div class="mt15">
            <div class="panel panel-default p15 b-t">
               <div class="clearfix p20">
                    <div class="col-sm-12">
                        <table style="font-size:14px;width:100%;">
                            ...
                            <tr>
                                <td><b>No. Polisi</b></td>
                                <td><b>:</b></td>
                                <td> <?php echo $data_info->nopol;?></td>
                            </tr>
                            <tr>
				...
				<br/>
				<b><h4>Info Pengeluaran Barang</h4></b><br/>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#bahan-item-table").appTable({
            source: '<?php echo_uri("inventory/pengeluaran/item_list_data/". $data_info->id) ?>',
            order: [[0, "asc"]],
            hideTools: true,
            columns: [
