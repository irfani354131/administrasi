<?php echo form_open(get_uri("inventory/pengeluaran/save_item"), array("id" => "invoice-item-form", "class" => "general-form", "role" => "form")); ?>
...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        ...
        <label for="invoice_item_quantity" class=" col-md-3"><?php echo lang('quantity'); ?> Keluar</label>
    ...
    function applySelect2OnItemTitle() {
        ...
        $("#invoice_item_title").select2({
            ...
            ajax: {
                ...
                url: "<?php echo get_uri("inventory/pengeluaran/get_item_suggestion_pengeluaran"); ?>",
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    ...
                    url: "<?php echo get_uri("inventory/pengeluaran/get_item_info_suggestion_pengeluaran"); ?>",
                    ...
                    success: function (response) {
                        ...
                        if (response && response.success) {
                                ...
                                $("#kode_produk").val(response.item_info.kode_produk);
                                 ...
                                 $("#description").val(response.item_info.deskripsi);
