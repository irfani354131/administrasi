        ...
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                ...
                //if ($this->login_user->is_admin) {
                   ...
                   echo modal_anchor(get_uri("inventory/produksi/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_produksi'), array("class" => "btn btn-primary", "title" => "Tambah Produksi"));
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#stock-table").appTable({
            ...
            source: '<?php echo_uri("inventory/produksi/list_data") ?>',

            // order: [[1, "asc"]],

            columns: [

                {title: 'NOMOR produksi', "class": "text-center"},
