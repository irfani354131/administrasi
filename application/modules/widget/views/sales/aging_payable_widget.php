<div class="box" >
	<div class="panel panel-primary" style="min-height: 200px;">
		<div class="panel-heading"><strong>Umur Hutang</strong> - <?php echo $date_range; ?></div>
		...
		<tr>
	        <td style="text-align: center"><strong><?php echo $row->code; ?> <br><?php echo getVendorInfo($row->fid_cust); ?></strong></td>
