        ...
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                ...
                //if ($this->login_user->is_admin) {
                   ...
                   echo modal_anchor(get_uri("employees/salary/modal_form"), "<i class='fa fa-plus-circle'></i> " . 'Tambah Salary', array("class" => "btn btn-primary", "title" => 'Tambah Salary'));
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#stock-table").appTable({
            ...
            source: '<?php echo_uri("employees/salary/list_data") ?>',

            // order: [[1, "asc"]],

            columns: [

                {title: 'NOMOR SALARY', "class": "text-center"},
