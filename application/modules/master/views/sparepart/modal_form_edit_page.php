...
?>
<?php echo form_open(get_uri("master/sparepart/savepage/".$menu), array("id" => "item-form", "class" => "general-form", "role" => "form")); ?>
...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
                <label for="code" class=" col-md-3"><?=$menu;?> Code</label>
                <div class=" col-md-9">
                    <?php
    ...
    <div class="form-group">
        ...
        <label for="title" class=" col-md-3">Nama <?=$menu;?></label>
    ...
    <div class="form-group">
        ...
        <label for="saldo" class=" col-md-3">Sisa <?=$menu;?></label>
...
<input type="hidden" name="tipe_kategori" id="tipe_kategori" value="<?=$tipe_kat;?>">
