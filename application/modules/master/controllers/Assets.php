...
class Assets extends MY_Controller {
    ...
    function modal_form() {
        $view_data['activa_dropdown'] = array("" => "-") + $this->Master_Coa_Type_model->getCoaDrop("account_number","1600");
        $view_data['expenses_dropdown'] = array("" => "-") + $this->Master_Coa_Type_model->getCoaDrop("account_number","6200");
        $view_data['coa_dropdown'] = array("" => "-") + $this->Master_Coa_Type_model->getCoaDrop("account_number","1100");
    ...
    function add() {
        ...
        $item_data = array(
            ...
            "asset_merk" => $this->input->post('asset_merk'),
            "asset_tahun_pembuatan" => $this->input->post('asset_tahun_pembuatan'),
            "asset_user" => $this->input->post('asset_user'),
            "asset_keterangan" => $this->input->post('asset_keterangan'),
    ...
    private function _make_item_row($data) {
        ...
        $from = new DateTime($data->get_date);
        $to   = new DateTime('today');
        $usia = $from->diff($to)->y;


        $persentase2 = (100 / 100) *  $usia;
        ...
        // }
        //$annual = $data->activa_pricing / $persentase - $residu;
        $annual = $data->activa_pricing/ $persentase2 - $residu;
        ...
        return array(
            ...
            $data->asset_name,
            $data->asset_merk,
            date("Y",strtotime($data->get_date,true)),
            //format_to_date($data->get_date,true),
