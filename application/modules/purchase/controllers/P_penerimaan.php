...
class P_penerimaan extends MY_Controller {
    ...
    function index() {
        ...
        $this->template->rander("payments/index_diterima");
    }
    ...
    private function _make_row($data) {
        ...
        $diterimaDate = $data->tgl_diterima;
        ...
        $row_data = array(
           // anchor(get_uri("purchase/p_payments/prints/" . $data->id."/".str_replace("/", "-", $data->code)), "#".$data->code),
            ...
            to_currency($total),
            strtoupper($data->diterima),
            $diterimaDate

        );


         $row_data[] = anchor("https://sia.dillahgroup.com/purchase/p_payments/download_pdf/".$data->id, "<i class='fa fa-print'></i>", array("class" => "view", "title" => lang('view'), "data-post-id" => $data->id)); 
