...
class Request extends MY_Controller {
    ...
    /* tolak or undo a client */

     function tolak($id){  
            $this->Purchase_Request_model->tolak($id);
            redirect(base_url().'purchase/request');
        }
    ...
    private function _make_row($data) {
     ...
     if($data->status != "paid" AND $data->is_verified == "0"){
        $row_data[] = anchor(get_uri("purchase/request/view/").$data->id, "<i class='fa fa-eye'></i>", array("class" => "view", "title" => lang('view'), "data-post-id" => $data->id)).modal_anchor(get_uri("purchase/request/modal_form_edit"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_client'), "data-post-id" => $data->id))
                .anchor(get_uri("purchase/request/tolak/").$data->id, "<i class='fa fa-times fa-fw'></i>", array("class" => "view", "title" => "Tolak Request Order", "data-post-id" => $data->id))
                .anchor(get_uri("purchase/request/approval/").$data->id, "<i class='fa fa-check'></i>", array("class" => "view", "title" => "Approval Request Order", "data-post-id" => $data->id));;
    }
         $row_data[] = anchor(get_uri("purchase/request/view/").$data->id, "<i class='fa fa-eye'></i>", array("class" => "view", "title" => lang('view'), "data-post-id" => $data->id));
        return $row_data;
    }
