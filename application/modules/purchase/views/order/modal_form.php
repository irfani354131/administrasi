<?php echo form_open(get_uri("purchase/p_order/add"), array("id" => "order-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            echo form_input(array(
                ...
                "value" => getMaxId('sales_order',"ORD"),
        ...
        $("#order-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('purchase/p_order/view'); ?>/" + result.id;
                }
            },
