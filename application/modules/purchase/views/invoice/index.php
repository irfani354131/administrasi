    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                ...
                <?php
                    echo modal_anchor(get_uri("purchase/p_invoices/modal_form"), "<i class='fa fa-plus-circle'></i> " . "Add Purchase Order", array("class" => "btn btn-primary", "title" => "Add Purchase Order"));
