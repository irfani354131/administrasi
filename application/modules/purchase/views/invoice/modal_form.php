...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            echo form_input(array(
                ...
                "value" => getMaxId('purchase_invoices',"PO"),
    ...
    <div class="form-group">
        ...
        <label for="fid_order" class=" col-md-3">REQ ORDER#</label>
            <div class=" col-md-9">
                <?php
                   echo form_dropdown("fid_quot", $quot_dropdown, "", "class='select2 validate-hidden' id='fid_order' required");
                    ?>
            </div>
    </div>  
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="via_pengiriman" class=" col-md-3">Via Pengiriman</label>
        <div class="col-md-9">
             <?php 
                echo form_textarea(array(
                "id" => "via_pengiriman",
