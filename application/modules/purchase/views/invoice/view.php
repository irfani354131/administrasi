<div id="page-content" class="clearfix">
    <div style="max-width: 1000px; margin: auto;">
        <div class="page-title clearfix mt15">
            <h1> PO #<?php echo $invoice_info->code; ?>
            ...
            <div class="title-button-group">
                <span class="dropdown inline-block">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li role="presentation"><?php echo modal_anchor(get_uri("purchase/p_invoices/modal_form_edit"), "<i class='fa fa-edit'></i> " . 'Edit PO', array("title" => 'Edit PO', "data-post-id" => $invoice_info->id, "role" => "menuitem", "tabindex" => "-1")); ?> </li>

                        <?php } ?>
                    </ul>
                        </span>
                 <?php if($invoice_info->paid != "paid" && $invoice_info->status != "posting" )  echo modal_anchor(get_uri("purchase/p_invoices/posting_modal_form/" . $invoice_info->id), "<i class='fa fa-money'></i> " . "Posting PO", array("class" => "btn btn-default","title" => "Posting to Journal", "data-post-id" => $invoice_info->id)); ?>
            </div>
        </div>
