            ...
            <div class="title-button-group">
                <span class="dropdown inline-block">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li role="presentation"><?php echo modal_anchor(get_uri("purchase/request/modal_form_edit"), "<i class='fa fa-edit'></i> " . 'Edit', array("title" => 'Edit', "data-post-id" => $invoice_info->id, "role" => "menuitem", "tabindex" => "-1")); ?> </li>
