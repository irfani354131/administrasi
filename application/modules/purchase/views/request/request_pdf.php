...
<div style=" margin: auto;">
    <center><span style="font-size:16px;font-weight: bold;"><u>FORM PERMINTAAN</u><br><?php echo $invoice_info->code; ?></span></center>
<br>    
    ...
    if ($invoice_style === "style_2") {
        $this->load->view('request_parts/header_style_2.php', $data);
    } else {
        $this->load->view('request_parts/header_style_1.php', $data);
    }
    ?>
</div>
...
<table style="width: 100%; color: #444;">            
    <tr style="font-weight: bold; background-color: <?php echo $color; ?>; color: #fff;  ">
        <th style="width: 20%; border-right: 1px solid #eee;"> <?php echo lang("item"); ?> </th>
        <th style="text-align: center;  width: 15%; border-right: 1px solid #eee;"> <?php echo lang("category"); ?></th>
    ...
    foreach ($invoice_items as $item) {
        ...
        <tr style="background-color: #f4f4f4; ">
            <td style="width: 20%; border: 1px solid #fff; padding: 10px;"><?php echo $item->title; ?>
                ...
                <td style="text-align: center; float: right"><?php echo $item->category; ?></td>
