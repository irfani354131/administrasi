<?php echo form_open(get_uri("purchase/p_payments/pay_save"), array("id" => "order-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            ...
            echo form_input(array(
                "id" => "voucher",
                "name" => "voucher",
                "value"=> getMaxId("purchase_payments","PAY"),
...
<?php } ?>
    ...
    <div class="form-group">
        <label for="bukti" class="col-md-3">Bukti Pembayaran</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "bukti",
