<?php echo form_open(get_uri("purchase/request_holding/save_item"), array("id" => "request_holding-item-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="id" value="<?php echo $model_info->id; ?>" />
    <input type="hidden" name="request_holding_id" value="<?php echo $request_holding_id; ?>" />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#request_holding-item-form .select2").select2();
        $("#request_holding-item-form").appForm({
            onSuccess: function (result) {
                $("#request_holding-item-table").appTable({newData: result.data, dataId: result.id});
        ...
        //re-initialize item suggestion dropdown on request_holding
    ...
    function applySelect2OnItemTitle() {
        $("#invoice_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("purchase/request_holding/get_item_suggestion"); ?>",
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    url: "<?php echo get_uri("purchase/request_holding/get_item_info_suggestion"); ?>",
