<span style="font-size:20px; font-weight: bold;background-color: <?php echo $color; ?>; color: #fff;">&nbsp;<?php echo $invoice_info->code; ?></span>
...
<span><?php echo "request_holding Date" . ": " . format_to_date($invoice_info->created_at, false); ?></span>