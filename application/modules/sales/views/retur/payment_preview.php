            ...
            <div class="panel panel-default  p15 no-border clearfix">
               ...
               <div class="pull-left">
                ...
                <div class="pull-right">
                    <a href="JavaScript:newPopup('<?=base_url();?>sales/s_retur/download_pdf/<?=$retur_info->fid_inv?>');" class="btn btn-default round"><i class='fa fa-print'></i> Print</a>
 ...
 <script type="text/javascript">
    ...
    function newPopup(url) {
      popupWindow = window.open(
        url,'popUpWindow','height=680,width=770,left=300,top=10,resizable=no,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no,status=yes')
    }
    </script>
