        ...
        <div class="page-title clearfix mt15">
            ...
            <div class="title-button-group">
                <span class="dropdown inline-block">
                    ...
                    <li role="presentation"><?php echo anchor(get_uri("sales/order/send_order/" . $invoice_info->id), "<i class='fa fa-envelope-o'></i> " . lang('send_order'), array("title" => lang('send_order'))); ?> </li>
