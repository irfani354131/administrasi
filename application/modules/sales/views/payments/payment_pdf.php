<div style=" margin: auto;">
    <center><span style="font-size:16px;font-weight: bold;"><u>PAYMENT NOTE</u><br><?php echo $payment_info->code; ?></span></center>
    <?php
    ...
    if ($invoice_style === "style_2") {
        $this->load->view('payment_parts/header_style_2.php', $data);
    } else {
        $this->load->view('payment_parts/header_style_1.php', $data);
    }
    ?>
</div>
...
<table style="width: 100%; color: #444;">            
   ...
   <?php   }  ?>
    ...
    <?php if ($invoice_total_summary->diskon > 0) { ?>
        <tr>
            <td colspan="3" style="text-align: right;">Potongan (<?php echo $invoice_total_summary->diskon; ?>%)</td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
