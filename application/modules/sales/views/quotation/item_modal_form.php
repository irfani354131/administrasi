<?php echo form_open(get_uri("sales/quotation/save_item"), array("id" => "quotation-item-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#quotation-item-form").appForm({
            onSuccess: function (result) {
                $("#quotation-item-table").appTable({newData: result.data, dataId: result.id});
    ...
    function applySelect2OnItemTitle() {
        $("#invoice_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("sales/quotation/get_item_suggestion"); ?>",
                dataType: 'json',
                quietMillis: 250,
