<div style=" margin: auto;">
    <center><span style="font-size:16px;font-weight: bold;"><u>INVOICE</u><br><?php echo $invoice_info->code; ?></span></center>
    <?php
...
<table style="width: 100%; color: #444;">            
    ...
    <th style="text-align: center;  width: 20%; border-right: 1px solid #eee;"> <?php echo lang("item"); ?></th>
        <th style="text-align: center;  width: 20%; border-right: 1px solid #eee;"> <?php echo lang("category"); ?></th>
        <th style="text-align: center;  width: 15%; border-right: 1px solid #eee;"> <?php echo lang("quantity"); ?></th>

        <th style="text-align: center;  width: 20%; border-right: 1px solid #eee;"> <?php echo lang("rate"); ?></th>
        <th style="text-align: center;  width: 20%; "> <?php echo lang("total"); ?></th>
    </tr>
    <?php
    ...
    foreach ($invoice_items as $item) {  ?>
        ...
        <tr style="background-color: #f4f4f4; ">
            <td style="width: 20%; border: 1px solid #fff; padding: 10px;"><?php echo $item->title; ?>
                <br />
                <span style="color: #888; font-size: 90%;"><?php echo nl2br($item->description); ?></span></td>
    
            <td style="text-align: left;  width: 20%; border: 1px solid #fff;"><?php echo $item->category; ?></td>
            <td style="text-align: center; width: 15%; border: 1px solid #fff;"> <?php echo $item->quantity . " " . $item->unit_type; ?></td>
            <td style="text-align: center; width: 20%; border: 1px solid #fff;"> <?php echo to_currency($item->rate ); ?></td>
            <td style="text-align: righcentert; width: 20%; border: 1px solid #fff;"> <?php echo to_currency($item->total); ?></td>
        </tr>
    <?php     }  ?>
    <tr>
