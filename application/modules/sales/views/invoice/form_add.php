<div id="page-content" class="clearfix" style="width: 1000px;margin:  auto">
    <div class="panel panel-default">
        ...
        <div class="col-md-6 modal-body clearfix">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <label for="fid_order" class=" col-md-3">PENJUALAN</label>
                    <div class=" col-md-8">
                         <select class='select2 validate-hidden' name="penjualan" >
            ...
            <div class="form-group">
                <label for="fid_cust" class="col-md-3">Nama Kustomer</label>
                <div class=" col-md-8">
                    <?php
            ...
            <div class="form-group">
        <label for="delivery_address" class=" col-md-3">Nama CS</label>
        <div class="col-md-9">
             <?php
            echo form_input(array(
                "id" => "nama_kapal",
        ...
        <div class="col-md-6 modal-body clearfix">
            ...
            <div class="form-group">
        <label for="potongan" class=" col-md-3">Potongan Harga %</label>
        <div class="col-md-9">
             <?php
            echo form_input(array(
                "id" => "potongan",
