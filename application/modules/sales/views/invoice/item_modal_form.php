<?php echo form_open(get_uri("sales/s_invoices/save_item"), array("id" => "invoice-item-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    ...
    function applySelect2OnItemTitle() {
        $("#invoice_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("sales/s_invoices/get_item_suggestion"); ?>",
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    url: "<?php echo get_uri("sales/s_invoices/get_item_info_suggestion"); ?>",
                    ...
                    success: function (response) {
                        ...
                        if (response && response.success) {
								...
								var maksim=response.item_info.bj_qty;
							$("#invoice_item_quantity").attr({
							   "max" : maksim,
							   "min" : 1
							});
                                ...
                                $("#invoice_item_basic").val(response.item_info.pricebarang);
                        }
                    }
                });
            }
