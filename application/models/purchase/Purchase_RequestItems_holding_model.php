...
class Purchase_RequestItems_holding_model extends Crud_model {
    ...
    function get_details($options = array()){
        ...
        $data = $this->db->query("SELECT * FROM purchase_request_items WHERE  deleted = 0  ".$where." ORDER BY id DESC");
        return $data;
    }
